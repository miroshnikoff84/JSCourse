...
let salaryAmount = querySelector('.salary-amount')[0];
let incomeTitle = querySelector('.income-title')[0];
let incomeAmount = querySelector('.income-amount')[0];
let expensesTitle = querySelector('.expenses-title')[0];
let expensesAmount = querySelector('.expenses-amount')[0];
let additionalExpensesItem = querySelector('.additional_expenses-item')[0];
let targetMount = querySelector('.target-amount')[0];
let periodSelect = querySelector('.period-select')[0];
